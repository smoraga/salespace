        ...
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <a href="#" class="task-thumb"><img src="<?php echo base_url('assets/img/avatar1.jpg')?>" alt=""></a>
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-hover personal-task">
                            ...
                            <tr>
                                <td>1</td>
                                <td>Target Sell</td>
                                <td>s<span class="badge bg-important">75%</span></td>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="album">
                                                        <a href="#"><img alt="" src="<?php echo base_url('assets/img/sm-img-1.jpg')?>"></a>
                                                        <a href="#"><img alt="" src="<?php echo base_url('assets/img/sm-img-2.jpg')?>"></a>
                                                        <a href="#"><img alt="" src="<?php echo base_url('assets/img/sm-img-3.jpg')?>"></a>
                                                        <a href="#"><img alt="" src="<?php echo base_url('assets/img/sm-img-1.jpg')?>"></a>
                                                        <a href="#"><img alt="" src="<?php echo base_url('assets/img/sm-img-2.jpg')?>"></a>
                                                    </div>
                                                </div>
                    ...
                    <section class="panel post-wrap pro-box">
                        ...
                        <aside class="post-highlight yellow v-align">
                            <div class="panel-body text-center">
                                <div class="pro-thumb">
                                    <img src="<?php echo base_url('assets/img/ring.jpg')?>" alt="">
                                </div>
                            </div>
                        </aside>
                    </section>
                                ...
                                <div class="follower">
                                    <div class="panel-body">
                                        ...
                                        <div class="follow-ava">
                                            <img src="<?php echo base_url('assets/img/follower-avatar.jpg')?>" alt="">
                                        </div>
                                    </div>
                                </div>
