...
<script type="text/javascript" src="<?php echo base_url('assets/js/plugins/jquery.dcjqaccordion.2.7.js')?>" class="include"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/plugins/jquery.sparkline.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js')?>"></script>
