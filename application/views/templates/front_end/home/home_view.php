...
<body>
<a href="javascript:void(0);" attr-name="supplier" onclick="set_client_type(1);">Register as Supplier</a>
<a href="javascript:void(0);" attr-name="reseller" onclick="set_client_type(2);">Register as Reseller</a>
